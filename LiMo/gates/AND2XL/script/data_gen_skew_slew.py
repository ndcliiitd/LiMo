...
def simulate(ocean_script, interim_output_file, simulator_name, design_dir, results_dir, model_file, stimulus_file, analysis_start, analysis_stop, analysis_step, load_1, slew_a_1, slew_b_1):
    ...
    print("Standard Output AND2XL:")
    print( ocean_script_output.stdout)

    print("Standard Error AND2XL:")
    ...
    if ocean_script_output.returncode == 0:
        print("Ocean environment started successfully AND2XL")
    else:
        print("Error: Failed to start ocean environment AND2XL")
...
print("DATASET GENERATION STARTED FOR GIVEN INPUT (AND2XL)")
...
print("\n**************************************\n")
print("\nDATASET GENERATION COMPLETED AND2XL\n")

# Stop the overall timer
total_end_time = time.time() 
total_elapsed_time = total_end_time - total_start_time
print(f"Total simulation time AND2XL: {total_elapsed_time} seconds")

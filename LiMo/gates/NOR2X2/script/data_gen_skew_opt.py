...
def simulate(ocean_script, interim_output_file, simulator_name, design_dir, results_dir, model_file, stimulus_file, analysis_start, analysis_stop, analysis_step, load_1, slew_a_1, slew_b_1):
    ...
    print("Standard Output NOR2X2:")
    print( ocean_script_output.stdout)

    print("Standard Error NOR2X2:")
    ...
    if ocean_script_output.returncode == 0:
        print("Ocean environment started successfully NOR2X2.")
    else:
        print("Error: Failed to start ocean environment NOR2X2")
...
for load_1 in pload:
    ...
    for slew_a_1 in pslew_a:
        ...
        for slew_b_1 in pslew_b:
            ...
            index = index+1
            print("DATASET GENERATION STARTED FOR GIVEN INPUT NOR2X2")
...
print(f"Total simulation time NOR2X2: {total_elapsed_time} seconds")

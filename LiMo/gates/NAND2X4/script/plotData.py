...
def load_data(data_path):
    ...
    data_head = ['load', 'slew_a', 'slew_b', 'process', 'voltage', 'temperature', 'skew_b', 'rise_delay', 'fall_delay', 'rise_slew', 'fall_slew']
...
def prepare_and_convert_data(data):
    ...
    selected_columns = ['load', 'slew_a', 'slew_b', 'process', 'voltage', 'temperature', 'skew_b', 'rise_delay', 'fall_delay', 'rise_slew', 'fall_slew']
    data = data[selected_columns]

    # Specify the columns to convert to float
    columns_to_convert = ['load', 'slew_a', 'slew_b', 'process', 'voltage', 'temperature', 'skew_b', 'rise_delay', 'fall_delay', 'rise_slew', 'fall_slew']
